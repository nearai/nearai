...
Experimental Typescript framework `docker build -f aws_runner/ts_runner_jutsu/Dockerfile --platform linux/amd64 --build-arg FRAMEWORK=-ts_jutsu -t nearai-runner:test .`
